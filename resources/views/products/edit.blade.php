...
<head>
    ...
    <title>{{ $product->name }} bewerken</title>
...
<div class="product-form-wrap">
    <div class="product-form-card">
        ...
        <h1 class="product-form-title">Product bewerken</h1>
        ...
        <form action="{{ route('products.update', $product) }}" method="POST">
            ...
            <div>
                <label for="image">Afbeelding (pad)</label>
                <input id="image" type="text" name="image" value="{{ old('image', $product->image) }}">
            </div>
